...
function mailsend($txt='', $header='' , $mail='szymon.grzegorski@op.pl'){
        // Naglowki mozna sformatowac tez w ten sposob.
        $naglowki = "From: Geek Factory <info@geekcity.pl>".PHP_EOL;
        ...
        return mail($mail, $header, $wiadomosc, $naglowki, 'info@geekcity.pl');
